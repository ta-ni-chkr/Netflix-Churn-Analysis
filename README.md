...
5. [Which device-subscription combinations dominate churned user behaviour?](#5-which-device-subscription-combinations-dominate-churned-user-behaviour)
6. [How do satisfaction, engagement, and support interactions vary between churned and retained users across subscription plans?](#6-how-do-satisfaction-engagement-and-support-interactions-vary-between-churned-and-retained-users-across-subscription-plans)
